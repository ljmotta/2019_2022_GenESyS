...
void DialogSimulationModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->_on_reject(); break;
        case 1: _t->on_horizontalSliderZoom_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->_on_graphicalmodelScene_mousemove((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

...
${OBJECTDIR}/Genesys++-driver.o: Genesys++-driver.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Genesys++-driver.o Genesys++-driver.cpp

${OBJECTDIR}/Genesys++-parser.o: Genesys++-parser.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Genesys++-parser.o Genesys++-parser.cpp

${OBJECTDIR}/Genesys++-scanner.o: Genesys++-scanner.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Genesys++-scanner.o Genesys++-scanner.cpp
...
${OBJECTDIR}/ParserFlexBisonImpl.o: ParserFlexBisonImpl.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParserFlexBisonImpl.o ParserFlexBisonImpl.cpp
...
${OBJECTDIR}/obj_t.o: obj_t.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/obj_t.o obj_t.cpp

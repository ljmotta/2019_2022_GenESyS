...
${OBJECTDIR}/GenesysShell.o: GenesysShell.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GenesysShell.o GenesysShell.cpp
...
${OBJECTDIR}/MyReGenESYsApplication.o: MyReGenESYsApplication.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyReGenESYsApplication.o MyReGenESYsApplication.cpp

...
${OBJECTDIR}/Model_AssignWrite3Seizes.o: Model_AssignWrite3Seizes.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model_AssignWrite3Seizes.o Model_AssignWrite3Seizes.cpp

${OBJECTDIR}/Model_CreateDelayDispose.o: Model_CreateDelayDispose.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model_CreateDelayDispose.o Model_CreateDelayDispose.cpp

${OBJECTDIR}/Model_CreateDelayDispose2.o: Model_CreateDelayDispose2.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model_CreateDelayDispose2.o Model_CreateDelayDispose2.cpp
